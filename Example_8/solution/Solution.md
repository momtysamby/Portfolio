...
- [Доступные методы](#доступные-методы)
  - [Метод PUT AddPerson](#метод-put-addperson)
    - [Адрес](#адрес)
    - [Тело запроса](#тело-запроса)
    - [Ответ](#ответ)
  - [Метод GET GetPosition](#метод-get-getposition)
    - [Адрес](#адрес-1)
    - [Тело запроса](#тело-запроса-1)
    - [Ответ](#ответ-1)
  - [Метод GET GetRoles](#метод-get-getroles)
    - [Адрес](#адрес-2)
    - [Тело запроса](#тело-запроса-2)
    - [Ответ](#ответ-2)
...
| Метод                                                                    | Описание                                                                               |
|--------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [PUT AddPerson](/Example_8/solution/Solution.md#метод-put-addperson)     | Добавление сотрудника в систему. Идемпотентный метод                                   |
...
| [GET GetPosition](/Example_8/solution/Solution.md#метод-get-getposition) | Получение должности сотрудника в организации                                           |
...
| [GET GetRoles](/Example_8/solution/Solution.md#метод-get-getroles)       | Получение всех ролей пользователя в организации                                        |
